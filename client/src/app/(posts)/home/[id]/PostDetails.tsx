               ...
               <div className="single__body">
                  <div className='single__post post'>
                     <div className="post__item">
                        ...
                        <div className="post__image">{data.imgUrl && <img src={`http://localhost:3005/${data.imgUrl}`} alt="..." />}</div>
                  ...
                  <div className="single__comments comments">
                     ...
                     <div className="comments__body">
                        { comments.data !== undefined && comments.data?.length ? comments.data.map((obj: IComment) => <CommentItem key={obj._id} {...obj} />) : '' }
                     </div>
                  </div>
               </div>
            }
